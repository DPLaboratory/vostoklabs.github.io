...
// The same library arranged for a person: a hand-picked Popular set and a dozen named
// groups over the raw categories. Shared so every symbol picker opens on the same page.
